...
import (
	...
	"github.com/GuanceCloud/cliutils/pipeline/ptinput/ip2isp"
...
func (p *Pipeline) Run(cat point.Category, pt *point.Point, plOpt *plscript.Option, ioPtOpt point.Option,
...
func Init(pipelineCfg *PipelineCfg) error {
	...
	if pipelineCfg.ReferTableURL != "" {
		...
		if err := refertable.InitReferTableRunner(
